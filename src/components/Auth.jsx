    ...
    <div className="auth-container">
      <div className={`auth-wrapper ${isSignUp ? "sign-up-mode" : ""}`}>
        ...
        <div className="forms-container">
          {/* Login Form */}
          <div className={`form-wrapper login-form-wrapper ${!isSignUp ? "active" : ""}`}>
          ...
          {/* Register Form */}
          <div className={`form-wrapper register-form-wrapper ${isSignUp ? "active" : ""}`}>
        ...
        <div className="info-panels">
          {/* Login Panel (right side when in login mode) */}
          <div className={`info-panel login-info ${!isSignUp ? "active" : ""}`}>
          ...
          {/* Register Panel (left side when in signup mode) */}
          <div className={`info-panel register-info ${isSignUp ? "active" : ""}`}>
            <div className="panel-content">
